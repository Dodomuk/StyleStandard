...
<head>
    ...
    <link rel="stylesheet" href="../../../resource/css/mysize_modify.css" type="text/css">
</head>
...
<!-- write start-->
<h3 class="wr"><span>설문조사</span></h3>
     <!-- Blog Section Begin -->
     <section class="pricing-section spad" style="padding-top: 60px; margin-right: 2%;">
    ...
    <tbody style="width: 100px">
        ...
        <tr>
            <th>키</th>
            <td>
                <input type="number" name="cmkg" value="" placeholder="ex) 170"> cm
            </td>
        </tr>
        <tr>
            <th>몸무게</th>
            <td>
                <input type="number" name="cmkg" value="" placeholder="ex) 70"> kg
            </td>
        </tr>
        ...
        <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <!-- 기타 누르면 인풋창 뜨게 하기 (기능구현으로)-->
                </td>
            </tr>

            <tr>
                <th>고객님의<br> 체형을 알려주세요!</th>
                <td>
                    <button type="button" class="btn btn-default">상체비만<br></button>
                    <button type="button" class="btn btn-default">하체비만<br></button>
                    <button type="button" class="btn btn-default">마름<br></button>
                    <button type="button" class="btn btn-default">보통<br></button>
                    <button type="button" class="btn btn-default">잘 모르겠어요<br></button>
