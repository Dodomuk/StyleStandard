        ...
        <div class="container">
                    ...
                    <div id="carouselExampleIndicators" class="carousel carousel-dark slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img src="/semi-templete/resource/img/stylelist/sample.jpg" class="d-block w-100" alt="...">
                          </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="col-6 d-grid p-1">
                                    <button type="button" class="btn btn-lg btn-dark" onclick = "location.href = '/semi-templete/cart/cart.jsp' ">장바구니 담기</button>
                                </div>
                                <div class="col-6 d-grid p-1">
                                    <button type="button" class="btn btn-lg btn-danger" onclick = "location.href = '/semi-templete/payment/paymentpage.jsp' ">주문하기</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-12" style="text-align: center;">
                    <img src="/semi-templete/resource/img/purchase/purchas.jpg" alt="">
                </div>
                <nav>
                    ...
                    <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                        <div class="row">
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <a href="/semi-templete/stylelist/leave_evaluation.jsp"><button class="btn btn-primary" type="button">리뷰작성</button></a>
                              </div>
                        </div>
                    </div>
                    <!-- 주문배송 -->
