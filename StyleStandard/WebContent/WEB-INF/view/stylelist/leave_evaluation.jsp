            ...
            <div class="row">
                <div class="col-lg-6">
                	<div class="embed-responsive embed-responsive-1by1">
					  <img class="embed-responsive-item" src=".."></img>
					</div>
				</div> 
                <div class="col-lg-6">
                    <form action="#" class="question-form">                   	
                        ...
                        <i class="fa fa-star-o fa-5x" aria-hidden="true"></i>
                        <i class="fa fa-star-o fa-5x" aria-hidden="true"></i>                        
                        <input class="mt-3" type="text" placeholder="제목">
                        <textarea placeholder="평가내용"></textarea>
                        <button type="submit" class="site-btn">평가남기기</button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="team__btn">
                        <a href="../stylelist/view_all_stylelist.jsp" class="primary-btn">전체 보기</a>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="team__item">
                        <div class="team__pic">
                            <img src="../../../resource/img/team/team-1.jpg" alt="">
                        </div>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="team__item">
                        <div class="team__pic">
                            <img src="../../../resource/img/team/team-2.jpg" alt="">
                        </div>
                        <div class="team__text">
                            <h5>스타일리스트2</h5>
                            <p>간단한 자기소개</p>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="team__item">
                        <div class="team__pic">
                            <img src="../../../resource/img/team/team-3.jpg" alt="">
                        </div>
                        <div class="team__text">
                            <h5>스타일리스트3</h5>
                            <p>간단한 자기소개</p>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="team__item">
                        <div class="team__pic">
                            <img src="../../../resource/img/team/team-4.jpg" alt="">
                        </div>
                        <div class="team__text">
                            <h5>스타일리스트4</h5>
                            <p>간단한 자기소개</p>
