...
<head>
    ...
    <link rel="stylesheet" href="../../../../../resource/css/stylemypage.css">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb__option">
                        ...
                        <a href="./index.jsp"> MyPage</a>
                        <span>StyleListPage</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="style__text">
                <div class="testimonial">
                    <img
                      src="img/test2.png"
                      alt=""
                      class="testimonial__avata"
                    />
                    <div class="testimonial__speech-bubble">
                      <p>
                        회원님 반갑습니다.
                      </p>
                      <a href="styelupload.jsp" class="btn btn-primary btn-floor" role="button" data-bs-toggle="button">등록</a>
                    </div>
                  </div>
            </div>
        </div>
            ...
            <div class="row monthly__plans active">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="pricing__item">
                        ...
                        <a href="#" class="primary-btn">주문 내역</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="pricing__item">
                        ...
                        <a href="#" class="primary-btn">회원정보</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="pricing__item">
                        ...
                        <a href="#" class="primary-btn">리뷰 남기기</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="pricing__item">
                        ...
                        <a href="#" class="primary-btn">사이즈</a>
                    </div>
                </div>
            </div>
