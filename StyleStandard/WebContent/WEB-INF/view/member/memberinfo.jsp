...
<div class="mb-3">
  ...
  <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="생년월일 1991-02-13">
</div>
<div class="mb-3">
  ...
  <div class="row g-3">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control" placeholder="주소" aria-label="City">
    </div>
    <div class="col-sm">
      <input type="text" class="form-control" placeholder="나머지 주소" aria-label="State">
    </div>
    <div class="col-sm">
      <input type="text" class="form-control" placeholder="우편번호" aria-label="Zip">
    </div>
  </div>

  <div class="mb-3">
    <label for="formGroupExampleInput" class="form-label">집 전화번호</label>
    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="집 전화번호 02-">
  </div>
  <div class="mb-3">
    <label for="formGroupExampleInput" class="form-label">핸드폰</label>
    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="핸드폰 010-">
  </div>
    ...
    <div class="btn-group" data-toggle="buttons">
        ...
        <label class="btn btn-primary active">
            <input type="radio" name="userGender" autocomplete="off" value="여자" checked>여자
                  ...
                  <div class="text-right"><a href="memberwithdraw.jsp">회원탈퇴</a></div>
        </form>
        <div class="btn_center"  style="text-align: center;">
            <a href="#" class="btn_type1" data-toggle="modal" data-target="#myModal">수정</a>
            ...
            <a href="../member/mypage.jsp" class="btn_type2">취소</a>
        </div>
        </div>
    </section>
    <!-- Blog Section End -->
