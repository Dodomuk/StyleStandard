...
<!-- Header End -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb__option">
                        <a href="./index.jsp"><span class="fa fa-home"></span> 메인페이지</a>
                        <a href="./index.jsp">문의 사항</a>
                        <!-- 송명재 문의하기 작성 -->
                        <a href="./index.jsp">문의 하기</a>
                        <!-- 필요하지 않은 것 같아서 주석처리 -->
                    </div>
                </div>
            </div>
    ...
    <section class="blog-hero-section">
     ...
     <!-- 1:1 문의하기 완료 송명재-->
   	 <section id="about one_to_one_question2" class="section section__container">
   	 <div>
   	 	<div class="text-center mb-4 fs-3">문의가 등록되었습니다.</div>
   	 	<div class="text-center"><a href="#">문의 내역 확인하러 가기>></a></div>
   	 </div>
